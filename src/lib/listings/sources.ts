...
export const HUNT_SOURCES = {
  boligsiden: { id: "boligsiden", label: "Boligsiden", enabled: true, timeoutMs: 8000 },
  boliga: { id: "boliga", label: "Boliga", enabled: true, timeoutMs: 4500 },
  classifieds: { id: "classifieds", label: "GulogGratis / DBA", enabled: true, timeoutMs: 4500 },
} as const;
